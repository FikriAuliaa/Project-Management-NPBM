      ...
      >
        {(provided, snapshot) => (
          <div
            ...
            className={`bg-white dark:bg-gray-800 p-4 rounded-xl shadow-sm border border-gray-200 dark:border-gray-600 hover:shadow-md hover:border-blue-300 dark:hover:border-blue-500 transition-all duration-200 group relative mb-3 ${snapshot.isDragging ? "shadow-xl ring-2 ring-blue-500 rotate-2 z-50 scale-105" : ""} ${isDragDisabled ? "cursor-pointer" : "cursor-grab active:cursor-grabbing"}`}
